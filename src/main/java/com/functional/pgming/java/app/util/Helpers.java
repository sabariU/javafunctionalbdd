...
public class Helpers {
    ...
    public static Path fileOutAllPath() throws URISyntaxException {
        URI uri = ClassLoader.getSystemResource(HelperConstants.CSV_All).toURI();
        return Paths.get(uri);
    }

    public static Path fileOutBeanPath() throws URISyntaxException {
        URI uri = ClassLoader.getSystemResource(HelperConstants.CSV_BEAN).toURI();
        return Paths.get(uri);
    }

    public static Path fileOutOnePath() throws URISyntaxException {
        URI uri = ClassLoader.getSystemResource(HelperConstants.CSV_ONE).toURI();
        return Paths.get(uri);
    }
    ...
    public static Path twoColumnCsvPath() throws URISyntaxException {
        URI uri = ClassLoader.getSystemResource(HelperConstants.TWO_COLUMN_CSV).toURI();
        return Paths.get(uri);
    }

    public static Path fourColumnCsvPath() throws URISyntaxException {
        URI uri = ClassLoader.getSystemResource(HelperConstants.FOUR_COLUMN_CSV).toURI();
        return Paths.get(uri);
    }

    public static Path namedColumnCsvPath() throws URISyntaxException {
        URI uri = ClassLoader.getSystemResource(HelperConstants.NAMED_COLUMN_CSV).toURI();
        return Paths.get(uri);
    }
    ...
    public static void err(Exception ex) {
        System.out.println(HelperConstants.GENERIC_EXCEPTION + " " + ex);
    }
}